...
const FormComponent = ({ rescueCentre, lastLocation, unsafe }) => {
	...
	const onSubmit = async (data) => {
		document.getElementById('form_submission').innerText = 'Submitted';
	...
	return (
		<Fragment>
			...
			<img
				src={require('../assets/img/experiment.jpg')}
				id="profile_pic"
			...
			<form className={classes.root} onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
				<div>
					...
					<TextField required id="1" label="Name of Sample" autoComplete="name" name="name" inputRef={register} />
					<TextField required id="2" label="Sample Other Details" autoComplete="details" name="details" inputRef={register} />
